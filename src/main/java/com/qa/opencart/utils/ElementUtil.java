...
public class ElementUtil {
	...
	@Step("entering value: {1}...for locator: {0}")
...
//			throw new FrameworkException("VALUECANNOTBENULL");
	...
	public boolean checkElementIsDisabled(By locator) {
		String disable_value = getElement(locator).getAttribute("disabled");
		if (disable_value.equals("true")) {
			return true;
		} else {
			return false;
		}
	...
	public  void doSearch(By searchlocator,By searchSuggLocator,String searchKey, String suggName) throws InterruptedException {
		...
		System.out.println("Number of suggestions = "+suggList.size());		
	...
	public  void doSelectDropDownByVisibleText(By locator, String Visibletext) {
		if (Visibletext == null) {
			System.out.println("Plaese pass the right visibletext and it  can not be null");
			return;
		}
		Select select = new Select(getElement(locator));
	...
	public  void multiLevelMenuHandling(By level1Locator, String level2, String level3)
			throws InterruptedException {
		act.moveToElement(getElement(level1Locator)).perform();
		Thread.sleep(1500);
		act.moveToElement(getLinkEleByText(level2)).perform();
	 ...
	 * @return
	 */
	@Step("waiting for element visible for locator: {0} with timeout: {1}")
	 ...
	 * @return
	 */
	@Step("waiting for page title and fetching.....")
	 ...
	 * @return
	 */
	@Step("waiting for page url and fetching.... urlfraction: {0} and timeout: {1}")
	...
	/**
	 * An expectation for the alert (JS) to be appeared on the apge
	 * @param timeOut
	 * @return
	 */
	...
	public  WebElement retryingElement(By locator, int timeOut) {
		...
		if (element == null) {
			System.out.println("Element is not found...... tried for "+timeOut+" secs "+"with the interval of "+500+" mili secs");
		}
	...
	public  WebElement retryingElement(By locator, int timeOut, long pollingTime) {
		...
		if (element == null) {
			System.out.println("Element is not found.....tried for "+timeOut+" secs "+"with the interval of "+pollingTime+" mili secs");
		}
